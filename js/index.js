...
random.addEventListener('mouseup',function(){
  $.ajax({
    dataType: "jsonp",
    url:  'https://api.instagram.com/v1/tags/hyperlapse/media/recent?client_id=0395f25a0fd1442cbba6458d7f021217'
  }).done(function(data){
...
var getVidFromID = function (id) {
    $.ajax({
        dataType: "jsonp",
        url:  'https://api.instagram.com/v1/media/'+id+'?client_id=0395f25a0fd1442cbba6458d7f021217'
      }).done(function(data2){
